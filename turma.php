	...
	<body class="">
		<div class="wrapper ">
			...
			<div class="main_content ">
				<div class="header">Cadastro de Turma</div>  
				<div class="info ">
					<?php
						include_once("formulario_turma.php");
					?>
				</div>
				<div class="header">Lista de Turma</div>  
				<div id="div_listar_turmas">
					<?php
						include_once("listagem_turma.php");
					?>
				</div>
			</div>
		</div>	
