	...
	<body class="">
		<div class="wrapper ">
			...
			<div class="main_content ">
				<div class="header">Cadastro de Frequência</div>  
				<div class="info ">
					<?php
						include_once("formulario_frequencia.php");
					?>
				</div>
				<div class="header">Lista de Frequência</div>  
				<div class="info ">
					<?php
						include_once("listagem_frequencia.php");
					?>
				</div>
			</div>
		</div>
